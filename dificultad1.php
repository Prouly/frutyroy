...
<head>
    <meta charset="UTF-8">
    <title>FrutyRoy - Dificultad Facil</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="shortcut icon" type="image/x-icon" href="img/logoMacedonia.ico">
    <link href="styles/styleFacil.css" rel="stylesheet" type="text/css">
</head>
<body>


    <div id="logo"></div>
    <div id="dificultad"><h1>  <a href="index.html"><img src="img/FrutyRoyLogo.png" alt="Logo FrutyRoy"></a><br>Dificultad Fácil <br>(puntuación máxima 600)</h1></div>
