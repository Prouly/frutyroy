...
<head>
    <meta charset="UTF-8">
    <title>FrutyRoy - Dificultad Media</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="shortcut icon" type="image/x-icon" href="img/logoMacedonia.ico">
    <link href="styles/styleMedio.css" rel="stylesheet" type="text/css">
</head>
<body>


    <div id="dificultad"><h1> <a href="index.html"><img src="img/FrutyRoyLogo.png" alt="Logo FrutyRoy"></a><br>Dificultad Media <br>(puntuación máxima 800)</h1></div>
    ...
    <?php
     ...
     ?>
    <table id="gameArea"><!--Area donde se muestra el juego-->
        <tr><!--Fila 1-->
            <td>
